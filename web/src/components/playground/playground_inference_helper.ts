/* ==========================================================================
   PLAYGROUND INFERENCE & TARGET GENERATOR HELPER (TypeScript)
   ========================================================================== */
...
export function generatePlaygroundDetections(config: Record<string, any>, streamId?: string) {
  ...
  return baseItems.filter((item, idx) => {
    ...
    return item.conf >= (config.conf || 0.25)
  })
}

export function calculateInferenceTelemetry(config: Record<string, any>) {
